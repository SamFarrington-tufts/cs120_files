...
<head>
    ...
    <title>SMX | Create An Account</title>
    <style type="text/css">
        body{
        ...
        .formNext input, .formSubmit input{
            display: block;
            margin: 20px auto;
            padding: 10px 20px;
        ...
        .formNext input:hover, .formSubmit input:hover{
        ...
        /*Makes sure footer always sits on bottom of page*/
        body{min-height: 100%;}
        body{min-height: 100vh; margin: 0; display: flex; flex-direction: column;}
        #wrap{flex: 1; display: flex; flex-direction: column; min-height: 60vh;}
